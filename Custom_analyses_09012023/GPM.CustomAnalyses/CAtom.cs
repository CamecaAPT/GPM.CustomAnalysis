...
public class CAtom
{
	public Color[] tabColor = { Colors.Blue, Colors.Red, Colors.Green, Colors.Yellow, Colors.Pink, Colors.Brown, Colors.Gray, Colors.Orange, Colors.Purple, Colors.White};
	// Variables
	// --------------
	public bool bState;
