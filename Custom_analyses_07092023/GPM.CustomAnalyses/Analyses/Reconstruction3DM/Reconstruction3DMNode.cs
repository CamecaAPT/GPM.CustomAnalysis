...
//using GPM.CustomAnalyses.Analyses.Reconstruction3DM.Preview;
...
[DefaultView(Reconstruction3DMViewModel.UniqueId, typeof(Reconstruction3DMViewModel))]
internal class Reconstruction3DMNode : StandardAnalysisNodeBase
{
	public const string UniqueId = "GPM.CustomAnalyses.Analyses.Reconstruction3DM.Reconstruction3DMNode";
	...
	public static INodeDisplayInfo DisplayInfo { get; } = new NodeDisplayInfo("Reconstruction3DM", ImageResource.PieChartIcon);
