...
internal class ClusterInformationMNode : StandardAnalysisNodeBase<EmptyProperties>
{
	...
	public static INodeDisplayInfo DisplayInfo { get; } = new NodeDisplayInfo("ClusterInformationM", ImageResource.PieChartIcon);
