...
public class CustomAnalysesModule : IModule
{
	...
	public void RegisterTypes(IContainerRegistry containerRegistry)
	{
		...
		containerRegistry.RegisterInstance(GibbsMNode.DisplayInfo, GibbsMNode.UniqueId);
		containerRegistry.Register<IAnalysisMenuFactory, GibbsMMenuFactory>(nameof(GibbsMMenuFactory));
		containerRegistry.Register<object, GibbsMViewModel>(GibbsMViewModel.UniqueId);
